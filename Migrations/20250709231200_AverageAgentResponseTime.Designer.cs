...
namespace CustomerService.API.Migrations
{
    ...
    [Migration("20250709231200_AverageAgentResponseTime")]
    partial class AverageAgentResponseTime
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomerService.API.Models.Conversation", b =>
                {
                    ...
                    b.Property<int?>("AgentLastReadMessageId")
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("AssignerLastReadMessageId")
                        .HasColumnType("int")
                    ...
                    b.Property<double?>("AverageAgentResponseTime")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("CustomerService.API.Models.MessageStatusHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MessageStatusHistory", (string)null);
                });
            ...
            modelBuilder.Entity("CustomerService.API.Models.WorkShift_User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CustomerService.API.Models.ContactLog", b =>
                {
                    ...
                    b.HasOne("CustomerService.API.Models.User", "VerifiedBy")
                        .WithMany("ContactLogs")
            ...
            modelBuilder.Entity("CustomerService.API.Models.WorkShift_User", b =>
                {
                    b.HasOne("CustomerService.API.Models.User", "AssignedUser")
                        .WithMany("WorkShift_UsersAssignedTo")
                    ...
                    b.HasOne("CustomerService.API.Models.User", "CreatedBy")
                        .WithMany("WorkShift_UsersCreatedBy")
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_WorkShift_User_CreatedBy");

                    b.HasOne("CustomerService.API.Models.OpeningHour", "OpeningHour")
                        .WithMany("WorkShift_Users")
                    ...
                    b.HasOne("CustomerService.API.Models.User", "UpdatedBy")
                        .WithMany("WorkShift_UsersUpdatedBy")
                        .HasForeignKey("UpdatedById")
                        .OnDelete(DeleteBehavior.Restrict)
            ...
            modelBuilder.Entity("CustomerService.API.Models.User", b =>
                {
                    ...
                    b.Navigation("WorkShift_UsersAssignedTo");

                    b.Navigation("WorkShift_UsersCreatedBy");

                    b.Navigation("WorkShift_UsersUpdatedBy");
                });
